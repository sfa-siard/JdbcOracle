...
public class OracleDriverTester {
    ...
    public void testWrapping() {
        assertSame("Registration of driver wrapper failed!", OracleDriver.class, _driver.getClass()); // TODO: check if this is important. Since we changed the register function, this is not true anymore
        assertSame("Choice of connection wrapper failed!", OracleConnection.class, _conn.getClass()); // TODO: check if this is important. Since we changed the register function, this is not true anymore
    } /* testWrapping */
